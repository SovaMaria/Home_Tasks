...
int[,] NewMatrixRandom2(int rows, int columns, int minElement, int maxElement)
{
...
int[,] matrix = NewMatrixRandom(2, 2, 1, 9);
PrintMatrix(matrix);
Console.WriteLine();
Console.WriteLine("Вторая матрица:");
int[,] matrix2 = NewMatrixRandom2(2, 2, 1, 9);
PrintMatrix(matrix2);
Console.WriteLine();
Console.WriteLine(@CheckMatrix(matrix, matrix2) ? "Резолютирующая матрица: "
